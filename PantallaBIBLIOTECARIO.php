...
<div>
    ...
    <center>
        <h3>CONTROL DE PRESTAMOS</h3><BR><BR>
        <a href="RegistrarPrestamo.php" type="button" class="btn btn-Warning" >Registrar préstamos</a>
        <a href="Devolucion.php" type="button" class="btn btn-info" >Registrar devolución</a>
        <br><br>
        <a href="ConfirmarReserva.php" type="button" class="btn btn-success" >Confirmar reserva</a>
