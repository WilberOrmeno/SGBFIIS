...
<body style="background-image: url(images/libros.jpg)">
  <form id="msform" action="PrestamoRealizado.php" method="POST">
        <fieldset style="margin-top: 0px; background-color: #E0E0E0">
            <h2 class="fs-title">Nuevo Prestamo</h2>
            <div align="left">
			...
			<select name="txtDocumento" class="form-control"  style="width:100%"><?php echo $comboDocumentos;?></select>
			</div>
            <br>
			<div align="left">
